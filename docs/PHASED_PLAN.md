...
Active work-order note: the current explicit handoff (see
...
tracker), and Stage 4 prototype memory with memory-relative novelty, all logged
and replayable. Next in order: episodic memory, percept-graph integration,
categories, consolidation proposals, then the KSG sink. Stage 5 and Stage 8 remain
